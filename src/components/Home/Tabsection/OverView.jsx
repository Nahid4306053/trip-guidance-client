...
export default function OverView() {
  return (
    <div className='flex  flex-col lg:flex-row gap-20 mt-10'>
     ...
     <h1 style={{lineHeight:"60px"}} className='title   text-5xl  max-w-md text-sky-900 font-bold '>We’re Trusted by More Than <span className='italic text-sky-500 font-medium'>84,106</span> Clients</h1>
