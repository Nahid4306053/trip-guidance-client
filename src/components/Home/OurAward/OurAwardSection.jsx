    ...
    <div className="bg-sky-900 lg:h-[450px] py-20 lg:mb-40">
      ...
      <div className="container mx-auto mt-20 lg:mt-0">
        <div className="grid grid-cols-1 font-Nunito lg:translate-y-1/4 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className={`Card py-10 px-14 hover:text-white hover:bg-blue-900 transition-all group  ${Darkmood ? "bg-base-300" : "bg-white"}  text-center`}>
            <div className={`icon group-hover:text-white ${Darkmood ? "text-white" : "text-sky-900"}     text-7xl mb-4 `}>
