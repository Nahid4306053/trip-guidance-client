...
export default function ToureGideCard({ data }) {
  ...
  return (
    <div className={`team_card ${Darkmood ? "bg-base-300": "bg-blue-200"}   h-[550px] rounded-md shadow-lg overflow-hidden relative flex flex-col items-center justify-center`}>
      ...
      <div className={`team_card_img absolute ${Darkmood ? "DarkBorader" : "ligthborader" }`}>
