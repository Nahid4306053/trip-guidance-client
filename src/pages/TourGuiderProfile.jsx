    ...
    <div>
     ...
     <div className='profile relative mb-20'>
      ...
      <div className='profileimg '>
        <img className='md:h-80 w-64 lg:-mt-40 p-2 bg-white shadow-lg bg-blue-00 -mt-32 h-64 md:w-80 object-cover rounded-full ' src={GuiderDetails.data.photoURL} alt="" />
      </div>
     ...
     <div className='addtional_info mt-14 grid gap-10 md:grid-cols-2 grid-cols-1 lg:grid-cols-3'>
      ...
      && <div className='bg-blue-100 min-h-[230px] flex relative flex-col justify-center items-center shadow-lg  rounded-lg py-10 px-5'>
      ...
      && <div className='bg-blue-100 min-h-[230px] relative flex flex-col justify-center items-center shadow-lg  rounded-lg py-10 px-5'>
