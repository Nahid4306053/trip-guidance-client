  ...
  return (
    <>
      <ToastContainer
        ...
        theme="light"
      />
      <Pagetitle>log in || TripGuidance</Pagetitle>
      {/* Same as */}
      ...
      >
        ...
        <div className="hero-content relative z-10 container">
          <div
            className={` overflow-hidden bg-blue-100 md:grid lg:grid-cols-5 md:grid-cols-6  items-center  shadow-black  shadow-2xl `}
          >
            <EntrypointDesc></EntrypointDesc>
            <div className=" bg-blue-100  p-10 text-blue-900 w-full md:col-span-3 lg:col-span-2 z-50">
              <div className="mb-10">
              ...
              <form onSubmit={handelesubmit} className="mt-5 space-y-5">
                ...
                <button
                  type="submit"
                  className="btn text-white w-full hover:bg-blue-900 bg-blue-900 border-none "
                >
                  Log in
                </button>
              </form>
              ...
              <button
                ...
                className="border border-blue-900 flex items-center justify-center gap-3  p-3 mt-6 w-full rounded-lg font-bold"
              >
                <img
                  className="h-6"
